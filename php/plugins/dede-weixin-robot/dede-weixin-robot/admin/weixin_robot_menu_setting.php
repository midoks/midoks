...
class weixin_robot_menu_setting{
	...
	public function run(){
		...
		if((!empty($opts['ai'])) || (!empty($opts['as']))){
			...
			echo '<tr><td background="'.$dede_url.'images/allbg.gif" colspan="5" align="center" bgcolor="#FFFFFF">';
	...
	public function keyReply(){
		...
		//头信息显示
		echo '<tr><td height="28" align="center" background="'.
			$dede_url.'images/tbg.gif" colspan="7" style="padding-left:10px;"><b>微信关键字自定义回复</b></td></tr>';
		echo($tableHeadTpl);
...
STR;
	...
	public function menuSetting(){
		...
		//菜单设置
		echo '<tr><td height="28" align="center" background="'.
			$dede_url.'images/tbg.gif" colspan="7" style="padding-left:10px;"><b>微信机器人自定义菜单设置</b></td></tr>';
