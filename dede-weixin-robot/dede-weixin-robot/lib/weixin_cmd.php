...
class weixin_cmd{
	...
	public function __construct(){
		...
		include(WEIXIN_ROOT_API.'weixin_robot_api_dede_db.php');
		$this->db = new weixin_robot_api_dede_db();//自建数据管理

		include_once(WEIXIN_ROOT_API.'weixin_robot_api_dede.php');
		//var_dump($_GET);
		$this->wp_db = new weixin_robot_api_dede($this);//dede数据库管理
