    ...
    watch(
        ...
        () => {
            ...
            const radius = Number.parseFloat(
                getCssVariableValue('--radius', false),
            );
            // 1rem = 16px
...
export function useNaiveDesignTokens() {
    ...
    watch(
        ...
        () => {
            ...
            commonTokens.invertedColor =
                getCssVariableValue('--background-deep');
    ...
    watch(
        ...
        () => {
            ...
            const variables: Record<string, string> = {
                ...
                '--el-border-radius-base': getCssVariableValue(
                    '--radius',
                    false,
                ),
                ...
                '--el-fill-color-lighter':
                    getCssVariableValue('--accent-lighter'),
